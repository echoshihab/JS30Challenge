...
For some of these challenges I recreateed the starter files from scratch to experiment and get comfortable with CSS GRID + Flex + added slight modifications to the the challenge/solutions as described below
